...
class BaseHandler(tornado.web.RequestHandler):
    ...
    def __init__(self, application, request, logger, request_id=None, **kwargs):
        ...
        application.initialize_handler_loggers(self)
    ...
    def initialize_sentry_logger(self, sentry_handler):
        """ This method is called when Sentry logger is used first time during the request to log some exception"""
        pass
